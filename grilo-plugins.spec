...
Source0  : https://download.gnome.org/sources/grilo-plugins/0.3/grilo-plugins-0.3.14.tar.xz
...
%prep
%setup -q -n grilo-plugins-0.3.14
cd %{_builddir}/grilo-plugins-0.3.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633448740
...
cp %{_builddir}/grilo-plugins-0.3.14/COPYING %{buildroot}/usr/share/package-licenses/grilo-plugins/caeb68c46fa36651acf592771d09de7937926bb3
