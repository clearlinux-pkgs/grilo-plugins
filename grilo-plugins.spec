...
Source0  : https://download.gnome.org/sources/grilo-plugins/0.3/grilo-plugins-0.3.13.tar.xz
...
%prep
%setup -q -n grilo-plugins-0.3.13
cd %{_builddir}/grilo-plugins-0.3.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622762944
...
cp %{_builddir}/grilo-plugins-0.3.13/COPYING %{buildroot}/usr/share/package-licenses/grilo-plugins/caeb68c46fa36651acf592771d09de7937926bb3
