...
%prep
%setup -q -n grilo-plugins-0.3.12
cd %{_builddir}/grilo-plugins-0.3.12
...
cp %{_builddir}/grilo-plugins-0.3.12/COPYING %{buildroot}/usr/share/package-licenses/grilo-plugins/caeb68c46fa36651acf592771d09de7937926bb3
