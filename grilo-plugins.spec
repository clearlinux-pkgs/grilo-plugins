...
Version  : 0.3.9
Release  : 12
URL      : https://download.gnome.org/sources/grilo-plugins/0.3/grilo-plugins-0.3.9.tar.xz
Source0  : https://download.gnome.org/sources/grilo-plugins/0.3/grilo-plugins-0.3.9.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568129283
